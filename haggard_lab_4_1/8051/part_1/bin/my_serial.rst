      ...
      002500                        493 _putchar:
                           ...
                           000001   500 	ar1 = 0x01
                           000000   501 	ar0 = 0x00
      002500 AF 83            [24]  502 	mov	r7,dph
      002502 E5 82            [12]  503 	mov	a,dpl
      002504 90 00 07         [24]  504 	mov	dptr,#_putchar_c_10000_3
      002507 F0               [24]  505 	movx	@dptr,a
      002508 EF               [12]  506 	mov	a,r7
      002509 A3               [24]  507 	inc	dptr
      00250A F0               [24]  508 	movx	@dptr,a
                                    509 ;	src/my_serial.c:14: while (!TI)
      00250B                        510 00101$:
                                    511 ;	src/my_serial.c:16: TI = 0;   // clear TI flag
                                    512 ;	assignBit
      00250B 10 99 02         [24]  513 	jbc	_TI,00118$
      00250E 80 FB            [24]  514 	sjmp	00101$
      002510                        515 00118$:
                                    516 ;	src/my_serial.c:17: SBUF = c; // load serial port with transmit value
      002510 90 00 07         [24]  517 	mov	dptr,#_putchar_c_10000_3
      002513 E0               [24]  518 	movx	a,@dptr
      002514 FE               [12]  519 	mov	r6,a
      002515 A3               [24]  520 	inc	dptr
      002516 E0               [24]  521 	movx	a,@dptr
      002517 FF               [12]  522 	mov	r7,a
      002518 8E 99            [24]  523 	mov	_SBUF,r6
                                    524 ;	src/my_serial.c:18: return c;
      00251A 8E 82            [24]  525 	mov	dpl, r6
      00251C 8F 83            [24]  526 	mov	dph, r7
                                    527 ;	src/my_serial.c:19: }
      00251E 22               [24]  528 	ret
                                    529 ;------------------------------------------------------------
      ...
      00251F                        538 00101$:
                                    ...
                                    540 ;	assignBit
      00251F 10 98 02         [24]  541 	jbc	_RI,00118$
      002522 80 FB            [24]  542 	sjmp	00101$
      002524                        543 00118$:
                                    544 ;	src/my_serial.c:27: return SBUF; // return character from SBUF
      002524 AE 99            [24]  545 	mov	r6,_SBUF
      002526 7F 00            [12]  546 	mov	r7,#0x00
      002528 8E 82            [24]  547 	mov	dpl, r6
      00252A 8F 83            [24]  548 	mov	dph, r7
                                    549 ;	src/my_serial.c:28: }
      00252C 22               [24]  550 	ret
                                    551 	.area CSEG    (CODE)
                                    552 	.area CONST   (CODE)
                                    553 	.area XINIT   (CODE)
